...
manage_room= generic_api(Room, roomserializers)
manage_student= generic_api(Student, studentserializers)
manage_payment= generic_api(Payment, paymentserializers)
manage_complaint = generic_api(Complaint, complaintserializers)
